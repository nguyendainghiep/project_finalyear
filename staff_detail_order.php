...
<body>
    <div class="container mt-4">
        ...
        <a href='?page=chat&id=<?php echo htmlspecialchars($order_info['userID']); ?>'style="margin-top: 24px;" class='btn btn-success'><i class='fa-solid fa-comments-dollar'></i> Contact</a>                        
