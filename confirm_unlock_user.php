...
<body>
    <div class="container">
        <div class="confirm-delete mt-5">
            <h3 class="text-center mb-4">Confirm Unlock Account</h3>
            ...
            <form method="post" action="?page=unlock_user">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="d-flex justify-content-between">
                    <button type="submit" class="btn" style="color:white; background-color: green;">Unlock this account</button>
